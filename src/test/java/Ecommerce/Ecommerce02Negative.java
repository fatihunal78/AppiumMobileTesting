...
public class Ecommerce02Negative {
    ...
    public void test() throws MalformedURLException, InterruptedException {
      ...
      //  driver.findElementById("com.androidsample.generalstore:id/nameField").sendKeys("Appium");
       ...
       WebElement toastMsg = driver.findElementByXPath("//android.widget.Toast");

       Assert.assertEquals("Please enter your name",toastMsg.getAttribute("name"));
